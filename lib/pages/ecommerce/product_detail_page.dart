...
import 'package:pet_owner_mobile/widgets/ecommerce/review_card.dart';
...
class _ProductDetailPageState extends State<ProductDetailScreen> {
  ...
  late Future<ReviewsResponse> _reviewsFuture;
  ...
  void initState() {
    ...
    _reviewsFuture = _service.listProductReviews(
      productId: widget.productId,
      page: 1,
      limit: 5, // show up to 5 on the detail page
    );
  }
      ...
      children: [
        ...
        if (product.storeName != null) ...[
          ...
          Text(
            ...
            '${product.storeLocation != null ? " • ${product.storeLocation}" : ""}',
              ...
              children: [
                ...
                if (data.total > data.reviews.length)
                  Padding(
                    ...
                    child: Text(
                      '+${data.total - data.reviews.length} more reviews',
                      style: TextStyle(
                        fontSize: sw * 0.03,
                        color: Colors.black45,
                      ),
